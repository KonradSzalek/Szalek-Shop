namespace szalkszop.Migrations
{
    ...
    public partial class AddingSearchProductsStoredProcedure : DbMigration
    {
        public override void Up()
		{
		   CreateStoredProcedure("SearchProducts"
			, c => new {
				Name = c.String(),
				PriceFrom = c.Double(),
				PriceTo = c.Double(),
			...
			(@ProductCategoryId is NULL OR p.ProductCategoryId = @ProductCategoryId) AND
			(p.IsActive = 'true')"
			);
		}
	...
	public override void Down()
		{
			DropStoredProcedure("SearchProducts");
		}
    }
}
